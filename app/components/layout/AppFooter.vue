                ...
                <v-row>
                    <v-col cols="12" md="5" class="mb-6">
                        <div class="footer-brand">
                            ...
                            <div class="brand-stack mt-4">
                                <code class="stack-line"
                                    ><span class="code-kw">const</span>
                                    <span class="code-var">stack</span> = [<span
                                        class="code-str"
                                        >'Vue'</span
                                    >, <span class="code-str">'Nuxt'</span>,
                                    <span class="code-str">'Node'</span>,
                                    <span class="code-str">'TS'</span>]</code
                                >
                            </div>
                        </div>
                    </v-col>
                    ...
                    <v-col cols="6" md="3">
                        <h4 class="col-heading">
                            <span class="heading-decorator">//</span>
                            {{ t("footer.navigate") }}
                        </h4>
                        <nav class="nav-list">
                            <NuxtLink
                ...
                <div class="footer-bottom">
                    ...
                    <div class="bottom-row">
                        <span class="copyright"
                            >&copy; {{ currentYear }} Lucas Mitori</span
                        >
                        <span class="built-with">
                            {{ t("footer.madeWith") }}
                            <v-icon size="12" color="error" class="mx-1"
                                >mdi-heart</v-icon
                            >
                            {{ t("footer.using") }} Nuxt 4 + Vuetify
                        </span>
...
const socials = [
    {
        icon: "mdi-github",
        url: "https://github.com/LucasMitori",
        label: "GitHub",
        handle: "@LucasMitori",
        color: "#8b5cf6",
    },
    {
        icon: "mdi-linkedin",
        url: "https://www.linkedin.com/in/lucas-mitori/",
        label: "LinkedIn",
        handle: "Lucas Mitori",
        color: "#0077b5",
    },
    {
        icon: "mdi-email",
        url: "mailto:devmitori@gmail.com",
        label: "Email",
        handle: "devmitori@gmail.com",
        color: "#ef4444",
    },
    {
        icon: "mdi-instagram",
        url: "https://www.instagram.com/lucasokumura/?hl=en",
        label: "Instagram",
        handle: "@lucasmitori",
        color: "#e1306c",
    },
...
onMounted(() => {
    ...
    function draw() {
        ...
        const primary =
            style.getPropertyValue("--v-theme-primary").trim() || "99,102,241";
...
.footer-transition {
    ...
    background: linear-gradient(
        180deg,
        transparent 0%,
        rgb(var(--v-theme-background), 0.5) 50%,
