  ...
  <section class="hero-section">
    ...
    <v-container class="hero-container" fluid>
      <v-row align="center" justify="center" class="hero-row">
        <v-col cols="12" md="6" class="hero-text-col">
          <div ref="heroContent" class="hero-content">
            <div class="hero-badge mb-3">
              ...
              <span class="badge-text">{{ t('home.heroSubtitleStatic') }}</span>
            </div>
            ...
            <div class="hero-typewriter mb-4">
              ...
              <TypewriterText :texts="heroSubtitles" :speed="60" :pause-duration="2000" />
            </div>

            <p class="hero-description mb-5">{{ t('home.heroDescription') }}</p>

            <div class="hero-actions d-flex gap-3 flex-wrap">
              <v-btn color="primary" size="large" prepend-icon="mdi-code-braces" rounded="lg" :to="localePath('/projects')">
                {{ t('home.heroCta') }}
              </v-btn>
              <v-btn variant="outlined" size="large" prepend-icon="mdi-account" rounded="lg" :to="localePath('/about')">
        ...
        <v-col cols="12" md="6" class="hero-visual-col d-none d-md-flex">
          <div ref="heroVisual" class="hero-visual">
            <div class="code-window">
              ...
              <div class="code-body">
                <div class="code-line"><span class="line-num">1</span><span class="kw">const</span> <span class="var">developer</span> = {</div>
                <div class="code-line"><span class="line-num">2</span>  <span class="prop">name</span>: <span class="str">"Lucas Mitori"</span>,</div>
                <div class="code-line"><span class="line-num">3</span>  <span class="prop">role</span>: <span class="str">"Fullstack Developer"</span>,</div>
                <div class="code-line"><span class="line-num">4</span>  <span class="prop">location</span>: <span class="str">"São Paulo, BR"</span>,</div>
                <div class="code-line"><span class="line-num">5</span>  <span class="prop">company</span>: <span class="str">"SaltCode"</span>,</div>
                <div class="code-line"><span class="line-num">6</span>  <span class="prop">skills</span>: [<span class="str">"Vue"</span>, <span class="str">"Nuxt"</span>, <span class="str">"Node"</span>, <span class="str">"..."</span>],</div>
                <div class="code-line"><span class="line-num">7</span>  <span class="prop">passion</span>: <span class="bool">true</span>,</div>
                <div class="code-line"><span class="line-num">8</span>};</div>
                <div class="code-line"><span class="line-num">9</span></div>
                <div class="code-line"><span class="line-num">10</span><span class="kw">export default</span> developer;</div>
                <div class="code-cursor" />
              </div>
            </div>
            <div class="orbit-ring">
              <div v-for="(tech, i) in orbitTechs" :key="tech.name" class="orbit-item" :style="getOrbitStyle(i)">
                <v-icon size="20" color="primary">{{ tech.icon }}</v-icon>
              </div>
            </div>
...
.grid-overlay {
  position: absolute;
  inset: 0;
  background-image: radial-gradient(circle at 1px 1px, rgb(var(--v-theme-primary), 0.04) 1px, transparent 0);
...
.kw { color: rgb(var(--v-theme-primary)); font-weight: 600; }
.var { color: rgb(var(--v-theme-secondary)); }
.prop { color: rgb(var(--v-theme-on-surface)); }
.str { color: #e8a86e; }
.bool { color: #7ec8e3; }
